...
function validateReferralId() {
    const input = document.getElementById("referral_Id").value.trim();
...
function validateForm() {
    ...
    const remaining_Days = document.getElementById("remaining_days").value;
    ...
    if (!indicator_Name || !date || !trading_View_Id || !referral_Id || !plan || !remaining_Days || !payment_Status || !amount_Paid) {
...
function addTableRow(indicator_Name, date, trading_View_Id, referral_Id, plan, remaining_Days, payment_Status, amount_Paid) {
